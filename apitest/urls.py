...
from .views import reg, log_in, log_out, new_app, new_api, ApiUpdate, ApiDelete, list_by_app, apiview, detail, app_list, AppUpdate, AppDelete, success, logview
urlpatterns = patterns('',
    ...
    url(r'^logs/(?P<app_id>\d+)/$', logview, name='viewlog'),
